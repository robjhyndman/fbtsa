 ...
 * We train a boosted random forest using feature inputs and labels equal to best-performing method on test sets. The optimization criterion is forecast accuracy not classification accuracy.
