...
* \textbf{ACF1}: first order autocorrelation = $\text{Corr}(Y_t,Y_{t-1})$
...
\end{block}
  ...
  * $\X_i \in$ a bivariate random sample $\{\X_1, \X_2, \ldots, \X_n\}$
  * $K_{\H}(\x)$ is the standard normal kernel function
